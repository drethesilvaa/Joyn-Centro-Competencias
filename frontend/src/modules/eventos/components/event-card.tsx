...
import { Clock, MapPin, Users, VideoCamera, Link as LinkIcon } from "phosphor-react"
...
export const EventCard: React.FC<EventCardProps> = ({ event, onSignUp }) => {
    ...
    const enrollmentPercentage = event.maxAttendees ? (event.attendeesCount / event.maxAttendees) * 100 : 0
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div className="relative">
                <img
                    ...
                    onError={(e) => {
                        e.currentTarget.src = '/eventos/default-event.jpg'
                    }}
                />
