...
const mockGoogleCalendarEvents: GoogleCalendarEvent[] = [
  {
    ...
    description:
      "Aprenda técnicas avançadas para aumentar sua produtividade no trabalho\\n\\nTópicos abordados:\\n- Gestão de tempo\\n- Ferramentas de automação\\n- Técnicas de foco",
    start: {
  ...
  },
  {
    ...
    description:
      "Atividades colaborativas para fortalecer as relações da equipe",
    start: {
  ...
  },
  {
    ...
    description:
      "Tendências tecnológicas e como aplicá-las no ambiente corporativo",
    start: {
...
export const EventosPage = () => {
  ...
  const { data } = useGetCalendars(session);
