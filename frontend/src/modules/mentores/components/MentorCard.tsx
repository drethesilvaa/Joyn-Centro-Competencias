                ...
                <div className='grid gap-6'>
                    <div className='flex gap-6'>
                        <div className="relative mb-5">
                            <Image width={200} height={200} src={person.photo} alt='photo' className="rounded-lg" />
                        </div>
                        <div className='w-full grid gap-4'>
                            ...
                            <div className='grid gap-1'>
                                {person?.stack && person?.stack?.map((stack, k) => (
                                    <div className='grid grid-cols-3 gap-2' key={k}>
                                        <p>{stack.name}</p>
                                        <Progress className='col-span-2' strokeColor={`var(--color-accent)`} showInfo={false} percent={stack.percent} />
                                    </div>
                                ))}
                            </div>
                        </div>
